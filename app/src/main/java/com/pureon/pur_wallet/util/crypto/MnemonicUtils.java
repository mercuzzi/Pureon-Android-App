...
public class MnemonicUtils {
    ...
    public static void initWordList(Context context) {
        ...
        InputStream is = context.getResources().openRawResource(R.raw.en_mnemonic_word_list) ;
        try {
            WORD_LIST = readAllLines(is);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
     ...
     */
    public static byte[] generateSeed(String mnemonic, String passphrase) throws IllegalArgumentException {
        if (isMnemonicEmpty(mnemonic)) {
    ...
    public static void validateMnemonic(String mnemonic) throws IllegalArgumentException {
