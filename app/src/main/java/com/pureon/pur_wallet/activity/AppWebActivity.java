...
import com.pureon.pur_wallet.constant.CytonDAppCallback;
import com.pureon.pur_wallet.item.App;
import com.pureon.pur_wallet.item.AppTitle;
import com.pureon.pur_wallet.item.Chain;
import com.pureon.pur_wallet.item.Wallet;
import com.pureon.pur_wallet.item.dapp.BaseCytonDAppCallback;
import com.pureon.pur_wallet.item.dapp.QrCode;
import com.pureon.pur_wallet.item.transaction.AppTransaction;
import com.pureon.pur_wallet.plugin.CytonDAppPlugin;
import com.pureon.pur_wallet.service.http.CytonSubscriber;
import com.pureon.pur_wallet.service.http.SignService;
import com.pureon.pur_wallet.service.http.WalletService;
import com.pureon.pur_wallet.constant.ConstantUtil;
import com.pureon.pur_wallet.util.JSLoadUtils;
import com.pureon.pur_wallet.util.NumberUtil;
import com.pureon.pur_wallet.util.PickPicUtils;
import com.pureon.pur_wallet.util.db.DBWalletUtil;
import com.pureon.pur_wallet.util.ether.EtherUtil;
import com.pureon.pur_wallet.util.exception.TransactionFormatException;
import com.pureon.pur_wallet.util.permission.PermissionUtil;
import com.pureon.pur_wallet.util.permission.RuntimeRationale;
import com.pureon.pur_wallet.util.qrcode.CodeUtils;
import com.pureon.pur_wallet.util.web.WebAppUtil;
import com.pureon.pur_wallet.view.WebErrorView;
import com.pureon.pur_wallet.view.WebMenuPopupWindow;
import com.pureon.pur_wallet.view.dialog.SignDialog;
import com.pureon.pur_wallet.view.webview.CytonWebView;
import com.pureon.pur_wallet.view.webview.SimpleWebViewClient;
import com.pureon.pur_wallet.view.webview.item.Address;
