package com.pureon.pur_wallet.activity.transactionlist.view;
...
import com.pureon.pur_wallet.activity.ReceiveQrCodeActivity;
import com.pureon.pur_wallet.activity.TransactionDetailActivity;
import com.pureon.pur_wallet.activity.transactionlist.model.TransactionAdapter;
import com.pureon.pur_wallet.activity.transactionlist.presenter.TransactionListPresenter;
import com.pureon.pur_wallet.activity.transfer.TransferActivity;
...
import com.pureon.pur_wallet.view.TokenProfileView;
import com.pureon.pur_wallet.view.loadmore.OnLoadMoreListener;
import com.pureon.pur_wallet.view.loadmore.RecyclerViewLoadMoreScroll;
...
public class TransactionListActivity extends NBaseActivity {
    ...
    private boolean isTestToken() {
        return ConstantUtil.DEFAULT_TOKEN_NAME.equalsIgnoreCase(token.symbol) || ConstantUtil.PUR_TOKEN_SYMBOL.equalsIgnoreCase(token.symbol);
    }
