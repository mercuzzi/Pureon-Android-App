package com.pureon.pur_wallet.constant;
...
public class ConstantUtil {
    ...
    public static final String PUR_CHAIN_ID = "2";
    public static final String PUR_CHAIN_NAME = "Ethereum Mainnet";
    public static final String PUR_TOKEN_NAME = "Pureon";
    public static final String PUR_TOKEN_SYMBOL = "PUR";
    public static final String PUR_TOKEN_AVATAR = "https://download.mba.cmbchina.biz/images/PUR-logo.jpg";
    public static final String PUR_HTTP_PROVIDER = "https://mainnet.infura.io/v3/9094bf7e58664495bcf6d7cf075c0937";
